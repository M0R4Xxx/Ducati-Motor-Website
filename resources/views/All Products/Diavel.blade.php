    ...
    <div class="container mx-auto px-6">
        <div class="flex justify-between items-center h-20 text-sm font-bold border-b border-white-500/50">
            ...
            <nav class="hidden md:flex items-center space-x-10 text-[11px] font-bold tracking-[0.25em] uppercase">
                ...
                <a class="text-primary border-b border-primary pb-1" href="/products/diavel">Diavel</a>
...
<section class="relative h-screen w-full flex items-end overflow-hidden group">
    <img alt="Motorcycle on Track" class="absolute inset-0 w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110" src="https://images.ctfassets.net/x7j9qwvpvr5s/2iMS483z9ovCLSGvfCt8uh/bfbc8f249a1a9a5f70efaa2b5d78ba64/Ducati-Diavel-V4-overview-hero-1600x1000.jpg"/>
    ...
    <div class="relative max-w-none w-full px-8 md:px-16 mb-24 text-left">
        <p class="text-sm font-bold tracking-[0.3em] uppercase mb-2">
            <span class="text-[#009246]">Dare </span> 
            <span class="text-white">to be</span> 
            <span class="text-[#CC0000]">Bold</span>
        </p>
        
        <h1 class="text-white text-6xl md:text-8xl font-black italic tracking-tighter uppercase mb-4">
            Diavel <span class="text-second italic">V4</span>
        </h1>
...
<section class="py-24 bg-background-light dark:bg-background-dark">
    <div class="max-w-4xl mx-auto px-6 text-center">
        <h2 class="text-4xl md:text-7xl font-black mb-6 dark:text-white uppercase tracking-tighter italic">
           Dare to <span class="text-primary not-italic font-light">be Bold</span> 
        </h2>
        ...
        <p class="text-xl md:text-2xl text-slate-500 dark:text-slate-400 leading-relaxed font-light italic">
            <span class="text-slate-900 dark:text-white font-bold not-italic underline decoration-primary decoration-4 underline-offset-8">Muscular, sporty, 
            exaggerated and elegant at the same time</span>, able to magnetize attention in any context, 
            Diavel V4 synthesizes seemingly distant technical, dynamic and stylistic features, such as those of sport nakeds and muscle roadster.
        </p>
    </div>
</section>
...
<section class="relative bg-white w-full overflow-hidden">
    <img 
        ...
        class="w-full h-[400px] md:h-[500px] object-cover block" 
        src="https://images.ctfassets.net/x7j9qwvpvr5s/4BYNVrinWFmP15McQxuZgC/93f0499d087dd702350c15f82a7e00dd/Ducati-Diavel-V4-design-hero-1600x1000.jpg"
    />
    
    <div class="absolute top-0 left-0 w-full h-full pointer-events-none flex items-center">
        <div class="max-w-7xl mx-auto px-6 w-full text-left">
            <div class="max-w-xl pointer-events-auto bg-black/40 md:bg-transparent p-6 md:p-0">
                <h2 class="text-white text-3xl md:text-5xl font-bold mb-4 md:mb-6 uppercase italic tracking-tighter">
                    Unmistakable design <span class="text-primary italic"></span>
                </h2>
                <p class="text-white text-base md:text-xl leading-relaxed font-light">
                    Muscular, gritty, with its broad "shoulders" and proudly visible four-exit exhaust, 
                    Diavel V4 is designed to convey boldness and not go unnoticed.
                </p>
            </div>
        </div>
    </div>
...
<section class="py-12 bg-gray-50 dark:bg-zinc-900">
    <div class="max-w-6xl mx-auto px-6 mb-16">
        <h2 class="text-5xl font-black mb-4 dark:text-white uppercase tracking-tighter italic">Muscle-roadster with <span class="text-primary">supersport personality</span></h2>
        ...
        <p class="max-w-2xl text-lg text-slate-500 dark:text-slate-400 font-light leading-relaxed">
            <span class="text-slate-900 dark:text-white font-bold">The V4 Granturismo takes center stage on our muscle bike</span> and allows it to express its personality to the fullest. Ducati's four-cylinder engine 
            guarantees high performance, combined with smoothness and regularity, at every rpm. The new chassis combines ideally with what have always been the Diavel's strengths, such as its characteristic riding position and comfort in medium-range touring. In addition, 
            thanks to a major weight reduction, handling and agility improve noticeably.
        </p>
    </div>
    
    <div class="grid grid-cols-1 md:grid-cols-12 gap-2 px-2">
        <div class="md:col-span-8 overflow-hidden group">
            <img alt="Action shot" class="w-full h-[500px] object-cover transition duration-700 group-hover:scale-105" src="https://images.ctfassets.net/x7j9qwvpvr5s/58E5bpWP5iH0QE0ZXeDiS4/41cebe91851b8ff096c010aeb48d451a/Ducati-Diavel-V4-overview-hero-1600x1000-02.jpg"/>
        </div>
        <div class="md:col-span-4 overflow-hidden group">
            <img alt="Front view" class="w-full h-[500px] object-cover transition duration-700 group-hover:scale-105" src="https://images.ctfassets.net/x7j9qwvpvr5s/2nOLdvdYGI6XUgRpDGozNG/e19c57451376de21390f4c9e92169674/Ducati-Diavel-V4-tech-spec-mosaic-gallery-1920x1080-02.jpg"/>
        </div>
        <div class="md:col-span-4 overflow-hidden group">
            <img alt="Detail view" class="w-full h-[400px] object-cover transition duration-700 group-hover:scale-105" src="https://images.ctfassets.net/x7j9qwvpvr5s/4AWv2cUUzGqHTAeV94zM97/2e851b055b6a4ab11e08b2e9023c8458/Ducati-Diavel-V4-tech-spec-mosaic-gallery-1080x1350-03.jpg"/>
        </div>
        <div class="md:col-span-8 overflow-hidden group">
            <img alt="Full profile" class="w-full h-[400px] object-cover transition duration-700 group-hover:scale-105" src="https://images.ctfassets.net/x7j9qwvpvr5s/17tipJ1hV8Vp50xHWbUHBK/72c958217009d9d1ae3acb2fc97f51d4/Ducati-Diavel-V4-overview-mosaic-gallery-1920x1080-05.jpg"/>
        </div>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div class="overflow-hidden bg-white dark:bg-zinc-900">
                <div class="h-auto w-full">
                    <img 
                        src="https://images.ctfassets.net/x7j9qwvpvr5s/3WNgnS6sHxAtU1GZ86VIys/7cde66e2107a3f0171acd1e1a2529dbf/1705-ENG-Curve-768x480.png" 
            ...
            <div class="h-full flex flex-col justify-center font-display italic">
                <div class="space-y-1"> 
                    <div class="flex justify-between py-5 border-b-2 border-slate-200/80 dark:border-zinc-800 group hover:border-primary transition-colors">
                        ...
                        <span class="text-xl font-bold dark:text-white">1,158 cc <span class="text-sm font-light opacity-60">(71 cu in)</span></span>
                    </div>
                    <div class="flex justify-between py-5 border-b-2 border-slate-200/80 dark:border-zinc-800 group hover:border-primary transition-colors">
                        ...
                        <span class="text-2xl font-black text-primary">168 hp (124 kW) <span class="text-sm font-light opacity-60">@ 10,750 rpm</span></span>
                    </div>
                    <div class="flex justify-between py-5 border-b-2 border-slate-200/80 dark:border-zinc-800 group hover:border-primary transition-colors">
                        ...
                        <span class="text-xl font-bold dark:text-white">12.8 kgm (126 Nm, 93 lb ft) <span class="text-sm font-light opacity-60">@ 7,500 rpm</span></span>
                    </div>
                    <div class="flex justify-between py-5 border-b-2 border-slate-200/80 dark:border-zinc-800 group hover:border-primary transition-colors">
                        ...
                        <span class="text-xl font-bold dark:text-white">223 kg <span class="text-sm font-light opacity-60">(492 lb)</span></span>
                    </div>
                    <div class="flex justify-between py-5 border-b-2 border-slate-200/80 dark:border-zinc-800 group hover:border-primary transition-colors">
                        ...
                        <span class="text-xl font-bold dark:text-white">790 mm <span class="text-sm font-light opacity-60">(31.1 in)</span></span>
                    </div>
                </div>
            </div>
        </div>
...
<section class="h-[40vh] w-full grid grid-cols-3 gap-0 overflow-hidden bg-black">
    <div class="h-full overflow-hidden group">
        <img alt="Detail 1" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" src="https://images.ctfassets.net/x7j9qwvpvr5s/4BJE0b0OFWBr8znml0pmY1/b0f293e11c0ed44145c06342b55c22e5/Ducati-Diavel-V4-overview-mosaic-gallery-1920x1080-01.jpg"/>
    </div>
    <div class="h-full overflow-hidden group">
        <img alt="Detail 2" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" src="https://images.ctfassets.net/x7j9qwvpvr5s/1Low4y52NN9REUaBksGpm6/546fb4f7b0b51e077da31a11c76087da/Ducati-Diavel-V4-overview-mosaic-gallery-1920x1080-04.jpg"/>
    </div>
    <div class="h-full overflow-hidden group">
        <img alt="Detail 3" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" src="https://images.ctfassets.net/x7j9qwvpvr5s/1R5kKIkIqTzIp7iiFhlcNl/728e61bc45c27be139f205106c16f841/Ducati-Diavel-V4-tech-spec-mosaic-gallery-1920x1080-04.jpg"/>
    </div>
</section>
