    ...
    <div class="container mx-auto px-6">
        <div class="flex justify-between items-center h-20 text-sm font-bold border-b border-white-500/50">
            ...
            <nav class="hidden md:flex items-center space-x-10 text-[11px] font-bold tracking-[0.25em] uppercase">
                ...
                <a class="text-primary border-b border-primary pb-1" href="/products/monster">Monster</a>
...
<section class="relative h-screen w-full flex items-end overflow-hidden group">
    <img alt="Motorcycle on Track" class="absolute inset-0 w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110" src="https://images.ctfassets.net/x7j9qwvpvr5s/6pxooXYl9uN1DpCB3EqqVE/9e37f44330e261f383d7833fe8f18608/monster-overview-hero-1600x1000-1.jpg"/>
...
<section class="py-24 bg-background-light dark:bg-background-dark">
    <div class="max-w-4xl mx-auto px-6 text-center">
        <h2 class="text-4xl md:text-7xl font-black mb-6 dark:text-white uppercase tracking-tighter italic">
           I M <span class="text-primary not-italic font-light">Legend</span> 
        </h2>
        ...
        <p class="text-xl md:text-2xl text-slate-500 dark:text-slate-400 leading-relaxed font-light italic">
            <span class="text-slate-900 dark:text-white font-bold not-italic underline decoration-primary decoration-4 underline-offset-8">Monster reinvents itself</span>. The fifth generation brings a fresh guise and a new heart: an updated design, the new V2 twin engine and cutting-edge electronic technologies.
...
<section class="relative bg-white w-full overflow-hidden">
    <img 
        ...
        src="https://images.ctfassets.net/x7j9qwvpvr5s/4uWs2WwMNng9NAFC11mUlX/9c887d7250497a28454b57d7353d0caa/monster-overview-banner-full-1330x600.jpg"
    />
        ...
        <div class="max-w-7xl mx-auto px-6 w-full text-left">
            <div class="max-w-xl pointer-events-auto bg-black/40 md:bg-transparent p-6 md:p-0">
                <h2 class="text-white text-3xl md:text-5xl font-bold mb-4 md:mb-6 uppercase italic tracking-tighter">
                    The <span class="text-primary italic">Monster</span>
                </h2>
                <p class="text-white text-base md:text-xl leading-relaxed font-light">
                    Contemporary and iconic, with an essential design, since decades the Monster family combines these elements to sportiness, fun and riding pleasure.
                </p>
            </div>
        </div>
    </div>
...
<section class="py-12 bg-gray-50 dark:bg-zinc-900">
    <div class="max-w-7xl mx-auto px-6 mb-16">
        <h2 class="text-5xl font-black mb-4 dark:text-white uppercase tracking-tighter italic">An icon that <span class="text-primary">continues to evolve</span></h2>
        ...
        <p class="max-w-2xl text-lg text-slate-500 dark:text-slate-400 font-light leading-relaxed">
            <span class="text-slate-900 dark:text-white font-bold">Modernity and heritage</span> interweave in a continuous dialogue, 
            in the most technological Monster of all time. A bike designed down to the finest details, that retains the same spirit it
             had when it changed Ducati forever: simple, pure and immediately recognisable.
        </p>
    </div>
    
    <div class="grid grid-cols-1 md:grid-cols-12 gap-2 px-2">
        <div class="md:col-span-8 overflow-hidden group">
            <img alt="Action shot" class="w-full h-[500px] object-cover transition duration-700 group-hover:scale-105" src="https://images.ctfassets.net/x7j9qwvpvr5s/4ZPDLDfl4hLppBu009xnQq/cf02a92e0f80a2a8d04abc6ded42ab6e/monster-veicolo-gallery-mosaic-1920x1080-04.jpg"/>
        </div>
        <div class="md:col-span-4 overflow-hidden group">
            <img alt="Front view" class="w-full h-[500px] object-cover transition duration-700 group-hover:scale-105" src="https://images.ctfassets.net/x7j9qwvpvr5s/3yMxq4fZxaNOjWVd8hatFz/884f8bf8cc4a08702c44cdda262ad847/monster-specifiche-tecniche-gallery-mosaic-1080x1350-02.jpg"/>
        </div>
        <div class="md:col-span-4 overflow-hidden group">
            <img alt="Detail view" class="w-full h-[400px] object-cover transition duration-700 group-hover:scale-105" src="https://images.ctfassets.net/x7j9qwvpvr5s/67TZ4HCUIavzywlANOfYvy/023a8c07b13fc40a6c2b4f7b8525b48d/monster-veicolo-gallery-mosaic-1080x1350-02.jpg"/>
        </div>
        <div class="md:col-span-8 overflow-hidden group">
            <img alt="Full profile" class="w-full h-[400px] object-cover transition duration-700 group-hover:scale-105" src="https://images.ctfassets.net/x7j9qwvpvr5s/3cgx8nIy66UoFyOTYnPG3J/75161966752b425c77f9de2f007a605c/monster-veicolo-gallery-mosaic-1920x1080-01.jpg"/>
        </div>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div class="overflow-hidden bg-white dark:bg-zinc-900">
                <div class="h-auto w-full">
                    <img 
                        src="https://images.ctfassets.net/x7j9qwvpvr5s/2lq6EzEmtB8FOk5RJmmwYH/74c58d8b6ea9b410451b97b110db090d/2025-10-20_Monster-ENG-Curve-768x480.jpg" 
            ...
            <div class="h-full flex flex-col justify-center font-display italic">
                <div class="space-y-1"> 
                    <div class="flex justify-between py-5 border-b-2 border-slate-200/80 dark:border-zinc-800 group hover:border-primary transition-colors">
                        ...
                        <span class="text-xl font-bold dark:text-white">890 cc <span class="text-sm font-light opacity-60">(54,3 cu in)</span></span>
                    </div>
                    <div class="flex justify-between py-5 border-b-2 border-slate-200/80 dark:border-zinc-800 group hover:border-primary transition-colors">
                        ...
                        <span class="text-2xl font-black text-primary">111 hp (81,6 kW) <span class="text-sm font-light opacity-60">@ 9.000 rpm</span></span>
                    </div>
                    <div class="flex justify-between py-5 border-b-2 border-slate-200/80 dark:border-zinc-800 group hover:border-primary transition-colors">
                        ...
                        <span class="text-xl font-bold dark:text-white">91,1 Nm (9,3 kgm, 67 lb ft) <span class="text-sm font-light opacity-60">@ 7.250 rpm</span></span>
                    </div>
                    <div class="flex justify-between py-5 border-b-2 border-slate-200/80 dark:border-zinc-800 group hover:border-primary transition-colors">
                        ...
                        <span class="text-xl font-bold dark:text-white">175 kg <span class="text-sm font-light opacity-60">(386 lb)</span></span>
                    </div>
                    <div class="flex justify-between py-5 border-b-2 border-slate-200/80 dark:border-zinc-800 group hover:border-primary transition-colors">
                        ...
                        <span class="text-xl font-bold dark:text-white">815 mm <span class="text-sm font-light opacity-60">(32,1 in)</span></span>
                    </div>
                </div>
            </div>
        </div>
...
<section class="h-[40vh] w-full grid grid-cols-3 gap-0 overflow-hidden bg-black">
    <div class="h-full overflow-hidden group">
        <img alt="Detail 1" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" src="https://images.ctfassets.net/x7j9qwvpvr5s/7z7KwG3xbOzOdj50uetMck/d56d71cceef1fb99d186471a5de3b980/monster-specifiche-tecniche-gallery-mosaic-1920x1080-04.jpg"/>
    </div>
    <div class="h-full overflow-hidden group">
        <img alt="Detail 2" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" src="https://images.ctfassets.net/x7j9qwvpvr5s/6qgpoozQhB7qmdudCxteUh/e740e77d9c269693435abd5646f8a168/monster-veicolo-gallery-mosaic-1920x1080-06.jpg"/>
    </div>
    <div class="h-full overflow-hidden group">
        <img alt="Detail 3" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" src="https://images.ctfassets.net/x7j9qwvpvr5s/BR2IApiMfl7xLCYXacpfI/cd20fe0b4116575d429152f551052541/monster-specifiche-tecniche-gallery-mosaic-1920x1080-05.jpg"/>
    </div>
</section>
