    ...
    <div class="container mx-auto px-6">
        <div class="flex justify-between items-center h-20 text-sm font-bold border-b border-white-500/50">
            ...
            <nav class="hidden md:flex items-center space-x-10 text-[11px] font-bold tracking-[0.25em] uppercase">
                ...
                <a class="text-primary border-b border-primary pb-1" href="/products/streetfighter">Streetfighter</a>
...
<section class="relative h-screen w-full flex items-end overflow-hidden group">
    <img alt="Motorcycle on Track" class="absolute inset-0 w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110" src="https://images.ctfassets.net/x7j9qwvpvr5s/6dDfm9d8fdRakoP2H37iwQ/aa2f186b1a1789816d225513ed6dc815/Ducati-Streetfighter-V2-V2S-overview-hero-short-1600x1000.jpg"/>
    ...
    <div class="relative max-w-none w-full px-8 md:px-16 mb-24 text-left">
        <p class="text-sm font-bold tracking-[0.3em] uppercase mb-2">
            <span class="text-[#009246]">The Next</span> 
            <span class="text-white">Level</span> 
            <span class="text-[#CC0000]">Formula</span>
        </p>
        
        <h1 class="text-white text-6xl md:text-8xl font-black italic tracking-tighter uppercase mb-4">
            Streetfighter <span class="text-primary italic">V4</span>
        </h1>
...
<section class="py-24 bg-background-light dark:bg-background-dark">
    <div class="max-w-4xl mx-auto px-6 text-center">
        <h2 class="text-4xl md:text-7xl font-black mb-6 dark:text-white uppercase tracking-tighter italic">
           The <span class="text-primary not-italic font-light">Next Level</span> Formula
        </h2>
        ...
        <p class="text-xl md:text-2xl text-slate-500 dark:text-slate-400 leading-relaxed font-light italic">
            The new Streetfighter V4 is the ultimate expression of <span class="text-slate-900 dark:text-white font-bold not-italic underline decoration-primary decoration-4 underline-offset-8">the Fight Formula, applied to the best ever Panigale</span>. Like never before, the Streetfighter inherits all the innovation and performance of the Ducati superbike, while retaining its unmistakable character, 
            gaining 6 hp over its predecessor. Powerful and precise on track, exciting and enjoyable on the road, 
            the Streetfighter V4 promises both feeling and control for an unparalleled riding experience.
        </p>
    </div>
</section>
...
<section class="relative bg-white w-full overflow-hidden">
    <img 
        ...
        class="w-full h-[670px] object-cover block" 
        src="https://images.ctfassets.net/x7j9qwvpvr5s/5HyOSiDogN13U4jRW80Hkm/e89a392b9ff372ac12c2752a08680390/Ducati-Streetfighter-V4-DWP25-overview-hero-short-1600x1000.jpg"
    />
</section>

<section class="py-12 bg-gray-50 dark:bg-zinc-900">
    <div class="max-w-7xl mx-auto px-6 mb-16">
        <h2 class="text-5xl font-black mb-4 dark:text-white uppercase tracking-tighter italic">The most powerful <span class="text-primary">Streetfighter category</span></h2>
        ...
        <p class="max-w-2xl text-lg text-slate-500 dark:text-slate-400 font-light leading-relaxed">
            As never before, <span class="text-slate-900 dark:text-white font-bold">the new Streetfighter V4</span> is the new Panigale V4 stripped of its fairings, 
            sharing also the same Desmosedici Stradale engine version. A magical
             combination that blends new design solutions, aerodynamics, ergonomics, chassis and electronics.
        </p>
    </div>
    
    <div class="grid grid-cols-1 md:grid-cols-12 gap-2 px-2">
        <div class="md:col-span-8 overflow-hidden group">
            <img alt="Action shot" class="w-full h-[500px] object-cover transition duration-700 group-hover:scale-105" src="https://images.ctfassets.net/x7j9qwvpvr5s/4u1QlewkEn4NCKQrh1V40d/3b45fc71e33169c17c8a33492a1a1e69/2025-04-24_Streetfighter-V4-gallery-mosaic-1920x1080-03.jpg"/>
        </div>
        <div class="md:col-span-4 overflow-hidden group">
            <img alt="Front view" class="w-full h-[500px] object-cover transition duration-700 group-hover:scale-105" src="https://images.ctfassets.net/x7j9qwvpvr5s/qsNx2gDKO4D2LJAxgzPZs/b3af6fc629ec13bdc25f1e5710daad75/2025-04-24_Streetfighter-V2-02-gallery-mosaic-1080x1350.jpg"/>
        </div>
        <div class="md:col-span-4 overflow-hidden group">
            <img alt="Detail view" class="w-full h-[400px] object-cover transition duration-700 group-hover:scale-105" src="https://images.ctfassets.net/x7j9qwvpvr5s/33pXqFzQFSDjixuAcT5Cf6/14a66c0c4ff36a2c46632f7c8d39fed3/2025-02-12_Streetfighter-V2-carousel-imgtext-full-1080x740.jpg"/>
        </div>
        <div class="md:col-span-8 overflow-hidden group">
            <img alt="Full profile" class="w-full h-[400px] object-cover transition duration-700 group-hover:scale-105" src="https://images.ctfassets.net/x7j9qwvpvr5s/7kxADmlzxPV5nxbP05SoHF/ced71317ee0f84cc689414068b5a23e7/Ducati-Streetfighter-V2-V2S-overview-mosaic-gallery-1920x1080-06.jpg"/>
        </div>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div class="overflow-hidden bg-white dark:bg-zinc-900">
                <div class="h-auto w-full">
                    <img 
                        src="https://images.ctfassets.net/x7j9qwvpvr5s/c6aIFh0KgoO6pcVtkchvi/281d21e173b656011f9520f23ee90a1c/Streetfighter-V4-ENG-Curve-768x480.jpg" 
            ...
            <div class="h-full flex flex-col justify-center font-display italic">
                <div class="space-y-1"> 
                    <div class="flex justify-between py-5 border-b-2 border-slate-200/80 dark:border-zinc-800 group hover:border-primary transition-colors">
                        ...
                        <span class="text-xl font-bold dark:text-white">1,103 <span class="text-sm font-light opacity-60">cc</span></span>
                    </div>
                    <div class="flex justify-between py-5 border-b-2 border-slate-200/80 dark:border-zinc-800 group hover:border-primary transition-colors">
                        ...
                        <span class="text-2xl font-black text-primary">157.4 kW (214 hp) <span class="text-sm font-light opacity-60">@ 13,500 rpm</span></span>
                    </div>
                    <div class="flex justify-between py-5 border-b-2 border-slate-200/80 dark:border-zinc-800 group hover:border-primary transition-colors">
                        ...
                        <span class="text-xl font-bold dark:text-white">120.0 Nm (88.5 lb-ft) <span class="text-sm font-light opacity-60">@ 11,250 rpm</span></span>
                    </div>
                    <div class="flex justify-between py-5 border-b-2 border-slate-200/80 dark:border-zinc-800 group hover:border-primary transition-colors">
                        ...
                        <span class="text-xl font-bold dark:text-white">189 kg <span class="text-sm font-light opacity-60">(417 lb)</span></span>
                    </div>
                    <div class="flex justify-between py-5 border-b-2 border-slate-200/80 dark:border-zinc-800 group hover:border-primary transition-colors">
                        ...
                        <span class="text-xl font-bold dark:text-white">845 mm <span class="text-sm font-light opacity-60">(33.3 in)</span></span>
                    </div>
                </div>
            </div>
        </div>
...
<section class="h-[40vh] w-full grid grid-cols-3 gap-0 overflow-hidden bg-black">
    <div class="h-full overflow-hidden group">
        <img alt="Detail 1" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" src="https://images.ctfassets.net/x7j9qwvpvr5s/4qr83pXKo8ImSE2DYU2jUL/a54be13f4e6b3a71c1cc1bed211e8b87/Ducati-Streetfighter-V2-V2S-overview-mosaic-gallery-1920x1080-04.jpg"/>
    </div>
    <div class="h-full overflow-hidden group">
        <img alt="Detail 2" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" src="https://images.ctfassets.net/x7j9qwvpvr5s/2DxYhFSdBNkQ0YQbRGHcFd/b992ef9f5ea743aecbf17849c5d5f8be/Ducati-Streetfighter-V2-V2S-overview-mosaic-gallery-1920x1080-05.jpg"/>
    </div>
    <div class="h-full overflow-hidden group">
        <img alt="Detail 3" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" src="https://images.ctfassets.net/x7j9qwvpvr5s/3AiiKp1U4OEjSJPGQizory/d6ca184a1bb743cee6f2d5a851b58250/Ducati-Streetfighter-V2-V2S-overview-mosaic-gallery-1920x1080-01.jpg"/>
    </div>
</section>
